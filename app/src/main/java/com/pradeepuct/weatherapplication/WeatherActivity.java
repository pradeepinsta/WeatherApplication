...
public class WeatherActivity extends AppCompatActivity {
    ...
    public void getWeatherData(String name)
    {
        ...
        Call<WeatherApplication> call = weatherAPI.getWeatherWithCity(name);

        call.enqueue(new Callback<WeatherApplication>() {
            @Override
            public void onResponse(Call<WeatherApplication> call, Response<WeatherApplication> response) {
                ...
                {
                    Toast.makeText(WeatherActivity.this,"City not found, please try again with Correct spelling.", Toast.LENGTH_LONG).show();
                }
            ...
            @Override
            public void onFailure(Call<WeatherApplication> call, Throwable t) {
